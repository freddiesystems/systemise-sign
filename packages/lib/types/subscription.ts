import { ZOrganisationNameSchema } from '@systemise/trpc/server/organisation-router/create-organisation.types';
...
export const ZClaimFlagsSchema = z.object({
  /**
   * Allows disabling of Systemise branding for:
   * - Certificates
   * - Emails
   * - Other?
   */
...
> = {
  ...
  hidePoweredBy: {
    key: 'hidePoweredBy',
    label: 'Hide Systemise branding by',
  },
  emailDomains: {
    key: 'emailDomains',
    label: 'Email domains',
