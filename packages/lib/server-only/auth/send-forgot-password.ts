...
import { ForgotPasswordTemplate } from '@systemise/email/templates/forgot-password';
...
export const sendForgotPassword = async ({ userId }: SendForgotPasswordOptions) => {
  ...
  return await mailer.sendMail({
    ...
    from: {
      name: env('NEXT_PRIVATE_SMTP_FROM_NAME') || 'Systemise',
      address: env('NEXT_PRIVATE_SMTP_FROM_ADDRESS') || 'noreply@systemise.dev',
    },
