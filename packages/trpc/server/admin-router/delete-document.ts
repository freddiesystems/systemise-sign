import { adminSuperDeleteDocument } from '@systemise/lib/server-only/admin/admin-super-delete-document';
import { sendDeleteEmail } from '@systemise/lib/server-only/document/send-delete-email';
