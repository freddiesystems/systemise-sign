import type { ImageLoadingState, PageRenderData } from '@systemise/lib/client-only/providers/envelope-render-provider';
import { PDF_VIEWER_PAGE_CLASSNAME } from '@systemise/lib/constants/pdf-viewer';
