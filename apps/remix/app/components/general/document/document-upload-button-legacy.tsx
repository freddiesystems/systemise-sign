...
import type { TCreateDocumentPayloadSchema } from '@systemise/trpc/server/document-router/create-document.types';
import type { TCreateTemplatePayloadSchema } from '@systemise/trpc/server/template-router/schema';
...
import { DocumentUploadButton as DocumentUploadButtonPrimitive } from '@systemise/ui/primitives/document-upload-button';
