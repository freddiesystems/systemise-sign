...
import { ZEditorRecipientsFormSchema } from '@systemise/lib/client-only/hooks/use-editor-recipients';
...
import type { TDetectedRecipientSchema } from '@systemise/lib/server-only/ai/envelope/detect-recipients/schema';
import { ZRecipientAuthOptionsSchema } from '@systemise/lib/types/document-auth';
import { nanoid } from '@systemise/lib/universal/id';
import { canRecipientBeModified as utilCanRecipientBeModified } from '@systemise/lib/utils/recipients';
import { trpc } from '@systemise/trpc/react';
import { RecipientActionAuthSelect } from '@systemise/ui/components/recipient/recipient-action-auth-select';
import {
  RecipientAutoCompleteInput,
  type RecipientAutoCompleteOption,
} from '@systemise/ui/components/recipient/recipient-autocomplete-input';
...
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@systemise/ui/primitives/card';
import { Checkbox } from '@systemise/ui/primitives/checkbox';
import { SigningOrderConfirmation } from '@systemise/ui/primitives/document-flow/signing-order-confirmation';
import { Form, FormControl, FormField, FormItem, FormLabel, FormMessage } from '@systemise/ui/primitives/form/form';
import { FormErrorMessage } from '@systemise/ui/primitives/form/form-error-message';
