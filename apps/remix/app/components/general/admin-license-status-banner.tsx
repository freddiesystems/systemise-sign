    ...
    >
      <div className="flex items-center justify-between gap-x-4 px-4 py-3 font-medium text-sm">
        <div className="flex items-center">
          ...
          {match(licenseStatus)
            ...
            .with('UNAUTHORIZED', () =>
              license ? (
                <Trans>
                  Invalid License Type - Your Systemise instance is using features that are not part of your license.
                </Trans>
              ) : (
                <Trans>Missing License - Your Systemise instance is using features that require a license.</Trans>
              ),
            )
            .otherwise(() => null)}
        </div>
        ...
        <Button
          ...
          asChild
        >
          <Link to="https://systemise.dev" target="_blank">
