...
import type { TDocumentAuditLog } from '@systemise/lib/types/document-audit-logs';
...
import { Dialog, DialogContent, DialogHeader, DialogTitle } from '@systemise/ui/primitives/dialog';
