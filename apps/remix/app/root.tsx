...
export function LayoutContent({ children }: { children: React.ReactNode }) {
  ...
  // Recipient routes (signing pages) put `systemise-branded` on <body> so the
  ...
  return (
    <html translate="no" lang={lang} data-theme={theme} className={theme ?? ''}>
      ...
      <body className={isRecipientRoute ? 'systemise-branded' : undefined}>
          ...
          <div className="bg-destructive text-destructive-foreground">
            <div className="mx-auto flex h-auto max-w-screen-xl items-center justify-center px-4 py-3 text-sm font-medium">
              <div className="flex items-center">
                ...
                <Trans>This is an expired license instance of Systemise</Trans>
              </div>
            </div>
          </div>
        )} */}
