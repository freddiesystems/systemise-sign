...
import { getDocumentByAccessToken } from '@systemise/lib/server-only/document/get-document-by-access-token';
...
export function meta({ params: { slug } }: Route.MetaArgs) {
  ...
  return [
    { title: 'Systemise - Share' },
    { description: 'I just signed a document with Systemise.' },
    {
      property: 'og:title',
      content: 'Signed with Systemise',
    },
    {
      property: 'og:description',
      content: 'I just signed a document with Systemise.',
    },
    {
      property: 'og:type',
      content: 'website',
...
export const loader = async ({ request, params: { slug } }: Route.LoaderArgs) => {
  ...
  // Hardcoded, as this whole meta block is hardcoded for Systemise anyway.
  throw redirect('https://systemise.dev');
};
