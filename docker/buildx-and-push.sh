...
docker buildx build \
    ...
    -t "systemise/systemise:latest" \
    -t "systemise/systemise:$GIT_SHA" \
    -t "systemise/systemise:$APP_VERSION" \
    -t "ghcr.io/systemise/systemise:latest" \
    -t "ghcr.io/systemise/systemise:$GIT_SHA" \
    -t "ghcr.io/systemise/systemise:$APP_VERSION" \
    --push \
    "$MONOREPO_ROOT"
